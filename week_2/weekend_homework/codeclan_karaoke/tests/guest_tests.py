...
class TestGuest(unittest.TestCase):
    def setUp(self):
        ...
        self.test_room_1 = Room('Skyfall', self.test_songs)
    ...
    def test_is_favourite_song_cheer(self):
        ...
        actual_output = self.test_guest_3.favourite_song(self.test_room_1.playlist)
        self.assertEqual(expected_output, actual_output)
        
    @unittest.skip('skipped')
    def test_is_not_favourite_song_cheer(self):
        expected_output = None
        actual_output = self.test_guest_2.favourite_song(self.test_room_1.playlist)
        self.assertEqual(expected_output, actual_output)
