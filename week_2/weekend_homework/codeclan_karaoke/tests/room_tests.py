...
class TestRoom(unittest.TestCase):
    def setUp(self):
        ...
        self.test_room_2 = Room('Crab Key', self.test_playlist, 2)
        
    # @unittest.skip('skipped')
    def test_is_room(self):
        self.assertEqual(self.test_room_1.name, 'Skyfall')
        self.assertEqual(len(self.test_room_1.playlist), 3)
        self.assertEqual(self.test_room_1.playlist[0].name, 'You know my name')
        self.assertEqual(len(self.test_room_1.guests), 0)
    ...
    # @unittest.skip('skipped')
    def test_remove_guest_from_room_guest_in_room(self):
        self.test_room_2.guests = [self.test_guest_1, self.test_guest_2]
        expected_output = False
        self.test_room_2.remove_guest(self.test_guest_2)
        actual_output = self.test_room_2.is_guest_in_room(self.test_guest_2)
        self.assertEqual(expected_output, actual_output)
        
    # @unittest.skip('skipped')
    def test_remove_guest_from_room_guest_not_in_room(self):
        self.test_room_2.guests = [self.test_guest_1]
        expected_outout = True
        self.test_room_2.remove_guest(self.test_guest_2)
        actual_output = self.test_room_2.is_guest_in_room(self.test_guest_1)
        self.assertEqual(expected_outout, actual_output)